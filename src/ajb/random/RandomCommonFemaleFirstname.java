...
public class RandomCommonFemaleFirstname {

    public static String get() {

        int randomInt = RandomInt.anyRandomIntRange(0, 299);

        String[] names = new String[] { "Mary", "Patricia", "Linda", "Barbara", "Elizabeth", "Jennifer", "Maria",
                ...
                "Jo", "Vickie", "Mattie", "Terry", "Maxine", "Irma", "Mabel", "Marsha", "Myrtle", "Lena", "Christy",
